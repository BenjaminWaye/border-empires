...
const TILE_FIELD_SPECS: TileFieldSpec[] = [
  ...
  { protoField: "prospect_signature", wireValue: "FERROUS_DUST", camelField: "prospectSignature", normalized: "FERROUS_DUST" },
  ...
  { protoField: "frontier_decay_kind", wireValue: "ENCIRCLEMENT", camelField: "frontierDecayKind", normalized: "ENCIRCLEMENT" },
