    ...
    const init = await buildInitMessage(
      ...
      store,
      {
        ...
        player: {
          ...
          strategicProductionPerMinute: { FOOD: 3, IRON: 0, CRYSTAL: 0, SUPPLY: 0, SHARD: 0 },
          economyBreakdown: { GOLD: { sources: [{ label: "Towns", amountPerMinute: 4.8, count: 2 }], sinks: [] }, FOOD: { sources: [{ label: "Grain", amountPerMinute: 3, count: 3 }], sinks: [] }, IRON: { sources: [], sinks: [] }, CRYSTAL: { sources: [], sinks: [] }, SUPPLY: { sources: [], sinks: [] }, SHARD: { sources: [], sinks: [] } },
          upkeepPerMinute: { food: 0.1, iron: 0, supply: 0, crystal: 0, gold: 0.2 },
    ...
    const message = await buildInitMessage(
      ...
      store,
      {
        ...
        player: {
          ...
          incomePerMinute: 1.2,
          strategicResources: { FOOD: 0, IRON: 0, CRYSTAL: 0, SUPPLY: 0, SHARD: 0 },
          strategicProductionPerMinute: { FOOD: 2, IRON: 0, CRYSTAL: 0, SUPPLY: 0, SHARD: 0 },
          developmentProcessLimit: 3,
