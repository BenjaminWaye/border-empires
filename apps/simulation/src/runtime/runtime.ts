...
import { applyReachAutoClaim, applyUnsettleDowngrade, createReachBorderApplyContext, type ReachBorderApplyContext } from "../runtime-reach-update/runtime-reach-border-apply.js"; import { createReachContestedDirtyState, type ReachContestedDirtyState } from "../runtime-reach-update/runtime-reach-contested-tiles.js"; import { flushAllReachUpdates } from "../runtime-reach-update/runtime-reach-flush-all.js";
...
export class SimulationRuntime {
  ...
  private readonly reachUpdateState: ReachUpdateState = createReachUpdateState(); private readonly reachContestedDirtyState: ReachContestedDirtyState = createReachContestedDirtyState(); // contested-tile TILE_DELTA_BATCH dirty set, see runtime-reach-contested-tiles.ts
