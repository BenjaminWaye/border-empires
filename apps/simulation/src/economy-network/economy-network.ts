...
import { supportTileBelongsToTown, hasSupportedStructure, countSupportedStructures } from "./economy-network-support-ring.js";
...
export { supportTileBelongsToTown, hasSupportedStructure, countSupportedStructures };
