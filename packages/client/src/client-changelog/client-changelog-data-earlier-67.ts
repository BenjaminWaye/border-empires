...
export const CLIENT_CHANGELOG_ENTRIES_EARLIER_67: ClientChangelogEntry[] = [
  ...
  // "Restored Town's manpower cap after the population-tier rebalance made
  // Thunder Bastion forts unbuildable at Town tier" (createdAt
  // 1788986490659, 2026.09.09.07) aged out of the "latest week" rolling
  // window the moment it was moved here and was removed from this array --
  // see git history for the original entry text.
];
