...
const RECENT_CLIENT_CHANGELOG_ENTRIES: ClientChangelogEntry[] = [
  ...
  },
  {
    ...
    introducedIn: "2026.08.30.4",
    title: "Aether Towers bring the high-aether zones to life on the 3D map",
    why: "The richest aether nodes on the map had no landmark -- a knowing eye could see the survey lines flickering, but the land itself still read as featureless grassland. The empire's transmission spires weren't there to be looked at, so the network (and the strategy around holding the strong aether fields) was invisible at a glance.",
    changes: [
      "Placing an Aether Tower on the 3D map now raises a tall brass-and-iron spire with a glowing cyan core, floating brass rings and upward-streaming motes",
      "Towers placed near each other light up thin cyan aether conduits with brass rails, collar joints, light nodes and travelling energy pulses, so a connected network reads as a visible web",
      "Where several towers stand close together a rotating geometric synchronization cluster forms between them, marking the strongest aether convergence on the map"
    ]
  }
];
