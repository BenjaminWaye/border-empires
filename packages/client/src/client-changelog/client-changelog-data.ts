...
const RECENT_CLIENT_CHANGELOG_ENTRIES: ClientChangelogEntry[] = [
  ...
  {
    createdAt: 1789926100453, // frozen, 1ms after the Voidcrystal Colossus entry
    ...
    changes: [
      ...
      "The existing Alerts panel (formerly \"Activity Feed\") keeps showing live, in-session notices as before -- it no longer also backfills your last 24 hours of history now that the Activity dashboard does that properly"
    ]
  },
];
