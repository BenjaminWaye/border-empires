...
const RECENT_CLIENT_CHANGELOG_ENTRIES: ClientChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      "Resource, dock, and town icons over the 3D map now redraw every frame instead of a throttled cadence, so they no longer lag or jitter behind the terrain while panning"
    ]
  },
  {
