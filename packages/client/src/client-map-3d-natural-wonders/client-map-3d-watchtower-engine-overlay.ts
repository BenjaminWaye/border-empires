...
// both the ownership overlay's tint (renderOrder 6/7, opacity up to 0.85)
// and the real water surface (renderOrder 12, see client-map-3d-water-
...
export const createWatchtowerEngineOverlay = (scene: Scene, maxTiles: number, cornerYAt: TerrainCornerSampler): WonderOverlay => {
  ...
  const dispose = (): void => {
    ...
    baseGeometry.dispose(); tubeGeometry.dispose();
