...
export const STRUCTURE_DISPLAY_NAMES: Partial<Record<EconomicStructureType | StructureInfoKey, string>> = {
  ...
  ADVANCED_UMBRITE_SYNTHESIZER: "High-Yield Umbrite Works",
  ...
  ASSEMBLY_WORKS: "Neural Works",
  ANCILLARY_DEPOT: "Ancillary Depot",
  RESERVE_LATTICE: "Reserve Lattice",
