...
import { EMPIRE_INTEGRITY_ENABLED, type ChosenTrickleResource } from "@border-empires/shared";
...
import { effectiveFogDisabled, setMapRevealEnabled, mapRevealAvailable } from "./client-map-reveal.js";
