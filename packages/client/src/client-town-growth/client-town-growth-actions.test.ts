...
describe("town growth tile actions", () => {
  ...
  it("shows a city growth action once a town is ready", () => {
    ...
    expect(action).toMatchObject({
      ...
      detail: "+25% gold income, 600 manpower cap."
    });
    expect(action?.disabled).toBe(false);
  });
  ...
  it("shows a great-city growth action that calls out the added support ring", () => {
    ...
    expect(action).toMatchObject({
      ...
      detail: "+150% gold income, 1200 manpower cap. Adds a second ring of support tiles around the town."
    });
    expect(action?.disabled).toBe(false);
  });
  ...
  it("shows a monumental city growth action for great cities", () => {
    ...
    expect(action).toMatchObject({
      ...
      detail: "+220% gold income, 2400 manpower cap."
    });
    expect(action?.disabled).toBe(false);
  });
