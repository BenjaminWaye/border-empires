...
// The Imperial Exchange is built from three uniquely-named components,
// each a real, distinct wire type (unique-monument-components rewrite):
// IMPERIAL_EXCHANGE_PART_1 (Golden Ledger), IMPERIAL_EXCHANGE_PART_2
// (Counting Engine), IMPERIAL_EXCHANGE_PART_3 (Sovereign Seal).
...
export const registerImperialExchangePartStructures = (
  ...
  return {
    layouts: {
      IMPERIAL_EXCHANGE_PART_1: addGoldenLedger,
      IMPERIAL_EXCHANGE_PART_2: addCountingEngine,
      IMPERIAL_EXCHANGE_PART_3: addSovereignSeal
    }
  };
};
