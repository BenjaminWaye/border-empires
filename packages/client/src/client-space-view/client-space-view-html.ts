...
export const spaceViewStyle = `
  ...
  /* Mounted as a child of #hud (see the stacking-order comment atop
     ...
     opened from within this screen -- 24 sits above the regular HUD chrome
     it's meant to cover (mini-map-wrap:20, mobile-sheet:21, mobile-nav:22,
     launchers:23) but below that overlay, side-panel:25, targeting:27 and
     auth:30, so none of those get buried behind Space View.
  ...
  .sv-screen{position:fixed;inset:0;z-index:24;background:#030712;display:flex;flex-direction:column;visibility:visible;pointer-events:auto}
