...
export const registerIndustrialStructures = (
  ...
  // ─── Slots ─────────────────────────────────────────────────────────
  // Foundry — reuses forge palette from economic.
  ...
  // Advanced ironworks — also reuses forge palette.
  builder.makeSlot("advIronBase", advIronBaseGeo, shared.forgeBaseMaterial, C);
  builder.makeSlot("advIronRoof", advIronRoofGeo, shared.barnRoofMaterial, C);
  builder.makeSlot("advIronFurnace", advIronFurnaceGeo, shared.forgeStoneMaterial, C);
  builder.makeSlot("advIronGlow", foundryGlowGeo, shared.forgeGlowMaterial, C);
  builder.makeSlot("advIronChimney", advIronChimneyGeo, shared.forgeChimneyMaterial, C * 2);
  ...
  const addAdvancedIronworks: IndustrialStructureLayout = (sx, sy, sz) => {
    builder.addPiece("advIronBase", sx, sy, sz, -0.06, 0.09, -0.04);
    builder.addPiece("advIronRoof", sx, sy, sz, -0.06, 0.245, -0.04, 1, 1, 1, Math.PI * 0.25);
    builder.addPiece("advIronFurnace", sx, sy, sz, 0.18, 0.11, -0.04);
    builder.addPiece("advIronGlow", sx, sy, sz, 0.18, 0.07, 0.05);
    builder.addPiece("advIronChimney", sx, sy, sz, 0.14, 0.32, -0.10);
    builder.addPiece("advIronChimney", sx, sy, sz, 0.22, 0.32, -0.10);
  };
