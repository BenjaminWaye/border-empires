...
import { createAetherBridgePylonOverlay } from "../client-map-3d-aether-bridge-pylon-overlay.js"; import { createAetherWallPylonOverlay } from "../client-map-3d-aether-wall-pylon-overlay.js"; import { createAetherWallPylonSync } from "../client-map-3d-aether-wall-pylon-sync.js";
...
const MAX_BRIDGE_PYLONS = 16; const MAX_WALL_PYLONS = 24;
...
export const createClientThreeTerrainRenderer = (deps: ClientThreeTerrainRendererDeps) => {
  ...
  const aetherBridgePylonOverlay = createAetherBridgePylonOverlay(scene, MAX_BRIDGE_PYLONS); const aetherWallPylonOverlay = createAetherWallPylonOverlay(scene, MAX_WALL_PYLONS);
  ...
  }; const syncAetherWallPylons = createAetherWallPylonSync(aetherWallPylonOverlay, heightfield.cornerYAt, deps.wrapX, deps.wrapY, sceneOrigin);
  ...
  const stop = (): void => {
    ...
    aetherBridgePylonOverlay.dispose(); aetherWallPylonOverlay.dispose();
