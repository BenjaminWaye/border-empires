...
// region (see isHillsRegionAt in worldgen-hills.ts), then moved again after
// the realistic-maps tectonic-plate continent shapes (worldgen-plates.ts)
// changed seed 1's terrain.
const seededHillsTile = { x: 100, y: 150 };
