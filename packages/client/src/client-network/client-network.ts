...
export const bindClientNetwork = (deps: NetworkDeps): void => {
  ...
  ws.addEventListener("message", (ev) => {
    ...
    if (msg.type === "COUNTRY_FLAG_SET") { state.myCountryFlag = typeof (msg as any).countryFlag === "string" ? (msg as any).countryFlag : state.myCountryFlag; state.countryFlagPickerOpen = false; renderHud(); return; }
    if (msg.type === "ERROR") {
