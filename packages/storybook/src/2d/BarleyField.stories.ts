...
const barleyOverlays = import.meta.glob("../../../client/public/overlays/farm-overlay-*.svg", {
  eager: true,
  query: "?url",
  import: "default"
...
const render = (args: Args): HTMLElement => {
  ...
  header.textContent = "Barley field overlays (raw resource tile)";
  ...
  for (const [path, url] of Object.entries(barleyOverlays)) {
