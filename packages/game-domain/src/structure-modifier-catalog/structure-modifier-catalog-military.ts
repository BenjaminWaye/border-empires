...
import {
  DREAD_TOWER_ATTACK_MULT, OBSERVATORY_VISION_BONUS, OBSERVATORY_RANGE, RELAY_BEACON_ATTACK_MULT,
...
export const militaryStructureModifiers = (type: ModifierStructureType): StructureModifier[] | undefined => {
  ...
  if (type === "RELAY_BEACON") return [{ statLabel: "Offense", valueText: multiplierPercentLabel(RELAY_BEACON_ATTACK_MULT), tone: "positive", isTownWide: false }];
