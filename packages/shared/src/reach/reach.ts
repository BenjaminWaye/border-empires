...
import {
  ...
  tileKeysInReach,
  wrapCoord
} from "./reach-geometry.js";
import type { LandConnectivityQuery, ReachAnchor, ReachAnchorKind } from "./reach-geometry.js";

// Re-exported for existing consumers that import these from reach.ts —
// the actual definitions live in reach-geometry.ts (split out to keep this
...
export type { LandConnectivityQuery, ReachAnchor, ReachAnchorKind };
