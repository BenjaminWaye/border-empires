...
// Every EXPAND fires a one-time discovery pulse over the surrounding area
// (same mechanic as a Watchtower's activation pulse), so pushing your
// frontier outward always reveals a burst of the map even though a FRONTIER
// tile itself no longer holds standing vision (see FRONTIER exclusion in
...
// outperforms a bare expand for real reconnaissance.
