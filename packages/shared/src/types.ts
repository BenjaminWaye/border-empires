...
export type LandBiome = "GRASS" | "SAND" | "COASTAL_SAND" | "TUNDRA" | "PLAINS" | "JUNGLE" | "MARSH" | "SNOW"; // PLAINS/JUNGLE/MARSH/SNOW (v8+) are visual-only promotions -- see visualLandBiomeAt in worldgen-visual-biome.ts
