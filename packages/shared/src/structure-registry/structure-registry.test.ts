...
import { STRUCTURE_REGISTRY, STRUCTURE_REGISTRY_SIZE } from "../structure-registry-index.js";
...
import { TECH_REQUIREMENTS_BY_STRUCTURE as LIVE_TECH_REQ } from "../structure-registry-economic.js";
...
describe("upkeep parity", () => {
  ...
  const noUpkeepTypes = new Set([
    ...
    "FARMSTEAD", "UMBRITE_RIG", "MINE", "MINTWORKS", "GRANARY",
    "CARAVANARY", "FOUNDRY",
