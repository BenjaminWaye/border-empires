...
export const ClientMessageSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    ...
    x: z.number().int(),
    y: z.number().int(),
    structureType: z.enum(["FARMSTEAD", "CAMP", "MINE", "MARKET", "GRANARY"])
  }),
  ...
  z.object({ type: z.literal("DEEP_STRIKE_ATTACK"), fromX: z.number().int(), fromY: z.number().int(), toX: z.number().int(), toY: z.number().int() }),
  z.object({ type: z.literal("NAVAL_INFILTRATION_ATTACK"), fromX: z.number().int(), fromY: z.number().int(), toX: z.number().int(), toY: z.number().int() }),
  z.object({ type: z.literal("SABOTAGE_TILE"), x: z.number().int(), y: z.number().int() }),
