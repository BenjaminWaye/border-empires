...
export const ECONOMIC_SPECS: Record<string, StructureSpec> = {
  ...
  WATERWORKS: econSpec("WATERWORKS", 600, { manpower: 80, strategic: { FOOD: 20 } }),
  ...
  SEED_GRANARY: econSpec("SEED_GRANARY", 1_400, { manpower: 100, strategic: { FOOD: 80 } }),
  CENSUS_HALL: econSpec("CENSUS_HALL", 900, { manpower: 80, strategic: { FOOD: 30 } }),
  BANK: econSpec("BANK", 3_200, {
    manpower: 300,
    upkeep: [FOOD_UPKEEP(0.1)],
  }),
  CLEARING_HOUSE: econSpec("CLEARING_HOUSE", 3_000, { manpower: 150, strategic: { CRYSTAL: 80 } }),
  ...
  AETHER_TOWER: econSpec("AETHER_TOWER", 6_000, { manpower: 400, strategic: { CRYSTAL: 160 } }),
