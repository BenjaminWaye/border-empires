...
export const SYNTH_OVERLOAD_GOLD_COST = 1_000;
export const SYNTH_OVERLOAD_DISABLE_MS = 24 * 60 * 60_000;
export const FUR_SYNTHESIZER_OVERLOAD_SUPPLY = 25;
export const IRONWORKS_OVERLOAD_IRON = 25;
export const CRYSTAL_SYNTHESIZER_OVERLOAD_CRYSTAL = 16;
...
export const FUR_SYNTHESIZER_GOLD_UPKEEP = 120;
export const IRONWORKS_GOLD_UPKEEP = 120;
export const CRYSTAL_SYNTHESIZER_GOLD_UPKEEP = 160;
